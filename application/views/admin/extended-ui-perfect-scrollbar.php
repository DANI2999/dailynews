...
>
  ...
  <body>
                ...
                <div class="col-md-6 col-sm-12">
                  <div class="card overflow-hidden mb-4" style="height: 300px">
                    ...
                    <div class="card-body" id="horizontal-example">
                      <img src="<?php echo base_url('public/admin/'); ?>assets/img/backgrounds/18.jpg" alt="scrollbar-image" />
                    </div>
                  </div>
                </div>
                <!--/ Horizontal Scrollbar -->
    ...
    <!-- Page JS -->
    <script src="<?php echo base_url('public/admin/'); ?>assets/js/extended-ui-perfect-scrollbar.js"></script>
