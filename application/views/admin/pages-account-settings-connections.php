                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/google.png" alt="google" class="me-3" height="30" />
                            </div>
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/slack.png" alt="slack" class="me-3" height="30" />
                            </div>
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/github.png" alt="github" class="me-3" height="30" />
                            </div>
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img
                                src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/mailchimp.png"
                                alt="mailchimp"
                                class="me-3"
                                height="30"
                              />
                          ...
                          <div class="d-flex">
                            <div class="flex-shrink-0">
                              <img src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/asana.png" alt="asana" class="me-3" height="30" />
                            </div>
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img
                                src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/facebook.png"
                                alt="facebook"
                                class="me-3"
                                height="30"
                              />
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img
                                src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/twitter.png"
                                alt="twitter"
                                class="me-3"
                                height="30"
                              />
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img
                                src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/instagram.png"
                                alt="instagram"
                                class="me-3"
                                height="30"
                              />
                          ...
                          <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                              <img
                                src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/dribbble.png"
                                alt="dribbble"
                                class="me-3"
                                height="30"
                              />
                          ...
                          <div class="d-flex">
                            <div class="flex-shrink-0">
                              <img
                                src="<?php echo base_url('public/admin/'); ?>assets/img/icons/brands/behance.png"
                                alt="behance"
                                class="me-3"
                                height="30"
                              />
