...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-4">
          <img
            src="<?php echo base_url('public/admin/'); ?>assets/img/illustrations/girl-doing-yoga-light.png"
