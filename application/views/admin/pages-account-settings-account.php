...
>
  ...
  <body>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="<?php echo base_url('public/admin/'); ?>assets/img/avatars/1.png"
                          alt="user-avatar"
    ...
    <!-- Page JS -->
    <script src="<?php echo base_url('public/admin/'); ?>assets/js/pages-account-settings-account.js"></script>
